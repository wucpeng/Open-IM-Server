...
type OnlineHistoryRedisConsumerHandler struct {
	//msgHandle            map[string]fcb   //deleted by wg 2022-12-05
...
func (och *OnlineHistoryRedisConsumerHandler) Init(cmdCh chan Cmd2Value) {
	//och.msgHandle = make(map[string]fcb)  //deleted by wg 2022-12-05
	...
	//if config.Config.ReliableStorage { //deleted by wg 2022-12-05
