...
func GetGroupMemberInfoFromCache(groupID, userID string) (*db.GroupMember, error) {
	...
	//log.NewInfo("GetGroupMemberInfoFromCache", "GetGroupMemberInfoFromCache", groupMemberInfoStr)
...
func GetUserConversationIDListFromCache(userID string) ([]string, error) {
	...
	conversationIDListStr, err := db.DB.Rc.Fetch(conversationIDListCache+userID, time.Second*60, getConversationIDList) //30*
...
func GetConversationFromCache(ownerUserID, conversationID string) (*db.Conversation, error) {
	...
	conversationStr, err := db.DB.Rc.Fetch(conversationCache+ownerUserID+":"+conversationID, time.Second*60, getConversation) //*30
	if err != nil {
