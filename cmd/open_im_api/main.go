...
func main() {
	...
	{
		groupRouterGroup.POST("/create_group", group.CreateGroup)                                   //1 hzt
		groupRouterGroup.POST("/set_group_info", group.SetGroupInfo)                                //1 hzt
		groupRouterGroup.POST("/join_group", group.JoinGroup)                                       //1
		groupRouterGroup.POST("/quit_group", group.QuitGroup)                                       //1 hzt
